  ...
  return (
    <Layout>
      ...
      <section>
        ...
        <nav>
          <ul className='indice'>
              <li><a href="#array">Arreglos / Arrays / Listas</a></li>
              <li><a href="#stacks">Pilas (Stacks)</a></li>
              <li><a href="#colas">Colas (Queues)</a></li>
              <li><a href="#lista">Listas Enlazadas (Linked Lists)</a></li>
              <li><a href="#map">Mapas / Diccionarios / Objetos</a></li>
              <li><a href='#sets'>Conjuntos (Sets)</a></li>
              <li><a href='#arboles'>Árboles y Grafos (concepto general)</a></li>
          </ul>
        </nav>
      </section>
